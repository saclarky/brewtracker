      ...
      <div class="hero-bottom">
        <div class="hero-content">
          <transition name="fade">
            <div v-if="performingRequest" class="loader"></div>
          </transition>
          <section>
            <div class="col2">
              <!-- LOGIN FORM -->
...
<div class='formRow'>
                  <label class='email' for="email3">Email:</label>
                  <input
  ...
  methods: {
    ...
    login() {
      ...
      fb.auth
        ...
        .catch((err) => {
          //todo - state more clearly if no such user, need to register. or... redirect? obnoxious?
          console.log("err", err);
...
.hero-content {
  min-width: 30%;
  background-color: rgb(105 87 79 / .5);
}
/* .hero-icon {
